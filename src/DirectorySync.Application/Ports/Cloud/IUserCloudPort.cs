...
{
    Task<ReadOnlyCollection<Identity>> GetUsersIdentitiesAsync(CancellationToken ct = default);
    Task<ReadOnlyCollection<CloudUserModel>> GetUsersAsync(CancellationToken ct = default);
